...
import { addProduct, getBlogStoryById, getBlogStories, getBlogPosts, getCareers, getEducationProgramBySlug, getEducationPrograms, getEvents, getProducts, getTestimonials, getTherapists, } from "../services/contentService.js";
...
contentRouter.get("/products", async (req, res, next) => {
    try {
        ...
        const products = typeFilter === "gift"
