...
export function parseMsg91AppointmentPayload(payload) {
    ...
    const rawPhone = pick(data, "phoneNumber", "phone_number", "phone", "sender", "from", "mobile", "mobileNumber", "mobile_number", "wa_id", "wa_number", "whatsapp_number", "customerNumber", "customer_number", "caller", "msisdn", "number", "user_phone", "user_id", "receiver");
    ...
    const rawChildName = pick(data, "childName", "child_name", "name_of_child", "nameOfChild", "child", "patientName", "patient_name", "name", "full_name", "customerName", "userName");
    ...
    const rawDate = pick(data, "appointmentDate", "appointment_date", "date", "selected_date", "date_of_appointment");
    ...
    const rawDepartment = pick(data, "department", "service", "selected_service", "service_name", "therapist_name", "therapistName", "doctor", "doctor_name");
    // Concern
    const rawConcern = pick(data, "concern", "main_concern", "mainConcern", "concern_of_child", "concernOfChild", "child_concern", "problem", "message");
