...
import { ChevronDown, Gift, Check, Send, Plus, Search, ShoppingCart, UserCircle, X } from "lucide-react";
    ...
    <div className="overflow-x-hidden bg-[#f8f3ef]">
      ...
      <section className="py-8 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Section Header with Inquiry Button */}
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 rounded-full bg-[#ffd86b] px-6 py-3 text-sm font-bold text-[#1a2d42] shadow-md transition-all hover:bg-[#fed154] hover:shadow-lg hover:-translate-y-0.5 shrink-0"
            >
              <div className="flex size-6 items-center justify-center rounded-full bg-[#1a2d42] text-[#ffd86b]">
          ...
          {/* Curated Products Full Width Grid */}
          <div>
            {isLoading ? (
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={idx} className="flex gap-3 items-start bg-white p-4 rounded-[1rem] border border-[#e8dfd8] shadow-sm">
          ...
          {/* Corporate Gifting Inquiry Modal Popup */}
          {isInquiryModalOpen && (
            <div 
            ...
            >
              <div 
                className="relative w-full max-w-xl my-8 rounded-[1.2rem] bg-[#fffdf8] p-3 shadow-2xl sm:rounded-[1.5rem] sm:p-4 animate-in fade-in zoom-in-95 duration-200"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="relative rounded-[1rem] bg-white p-5 sm:rounded-[1.2rem] sm:p-8">
                  {/* Close Button */}
                  <button
                    type="button"
                    onClick={() => setIsInquiryModalOpen(false)}
                    className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full bg-[#f4efe8] text-[#2b1b15] transition hover:bg-[#e8dfd8]"
