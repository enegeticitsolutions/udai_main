      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          >
            ...
            <h2 className="max-w-xl text-3xl font-semibold leading-tight tracking-tight sm:text-6xl">
              Your Time Can Change a Life Forever
            </h2>
            <p className="mt-5 max-w-xl text-base leading-7 text-white/82 sm:mt-8 sm:text-lg sm:leading-9">
